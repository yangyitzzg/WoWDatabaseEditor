...
//                .WithComponentData<Collider>()
        ...
        private IEnumerator LoadWDT()
        {
            ...
            if ( wdt.Header.flags.HasFlag(WdtFlags.WdtUsesGlobalMapObj) )
        ...
        private IEnumerator LoadWDTWorldMapObject(WDT wdt)
        {
            ...
            wmoTransform.Position = new Vector3((32 * Constants.BlockSize - wdt.WorldMapObject.pos.X),
                wdt.WorldMapObject.pos.Y, -(32 * Constants.BlockSize - wdt.WorldMapObject.pos.Z));
            wmoTransform.Rotation = Quaternion.FromEuler(wdt.WorldMapObject.rot.X, -wdt.WorldMapObject.rot.Y + 180,
                wdt.WorldMapObject.rot.Z);
